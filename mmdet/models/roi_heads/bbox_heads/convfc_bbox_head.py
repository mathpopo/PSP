        ...
        if self.proto:
            if self.proto == 1:
                prototype = torch.load(
                    '/media/hao/Data/RPC/single_features/RPC_Single_Image_Features_res50_200/prototype.pth')
            if self.proto == 2:
                prototype = torch.load(
                    '/media/hao/Data/RPC/single_features/RPC_Single_Image_Features_res50_200_val/prototype.pth')
